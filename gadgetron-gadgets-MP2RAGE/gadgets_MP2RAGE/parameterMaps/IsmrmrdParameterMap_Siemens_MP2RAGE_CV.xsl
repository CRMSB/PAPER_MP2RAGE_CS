    ...
    <xsl:template match="/">
        <ismrmrdHeader xsi:schemaLocation="http://www.ismrm.org/ISMRMRD ismrmrd.xsd"
            ...
            <encoding>
                ...
                <echoTrainLength>
                     <xsl:if test="siemens/MEAS/sFastImaging/lSegments">
            ...
            <userParameters>
		<xsl:if test="siemens/MEAS/sWipMemBlock/alFree[1]">
		   <userParameterLong>
                      <name>alFree1</name>
                            <value>
		...
		<xsl:if test="siemens/MEAS/sWipMemBlock/alFree[4]">
		   <userParameterLong>
                      <name>alFree4</name>
                            <value>
                                <xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[4]" />
                            </value>
                        </userParameterLong>
	    	</xsl:if>
		...
		<xsl:if test="siemens/MEAS/sWipMemBlock/alFree[5]">
		   <userParameterLong>
                      <name>alFree5</name>
                            <value>
                                <xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[5]" />
                            </value>
                        </userParameterLong>
	    	</xsl:if>

		<xsl:if test="siemens/MEAS/sWipMemBlock/alFree[7]">
		   <userParameterLong>
                      <name>alFree7</name>
                            <value>
                                <xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[7]" />
                            </value>
                        </userParameterLong>
	    	</xsl:if>

		<xsl:if test="siemens/MEAS/sWipMemBlock/alFree[8]">
		   <userParameterLong>
                      <name>alFree8</name>
                            <value>
